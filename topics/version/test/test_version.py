...
@pytest.mark.parametrize(
    "v1,v2,expected",
    [
        pytest.param(Version("1.5.3"), Version("1.5.3"), True, id="1.5.3==1.5.3"),
        pytest.param(Version("1.5.3"), Version("1.5.X"), True, id="1.5.3==1.5.X"),
    ],
)
def test_version_equal(v1, v2, expected):
